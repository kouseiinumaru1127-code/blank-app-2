...
if st.sidebar.button("＝LOVEメンバーをDBに追加（1回だけ押して！）"):
    ...
    members = [
        {"name": "逢田珠里依", "group_name": "≒JOY", "type": "かわいい", "charm": "歌", "message": "透明感たっぷりのピュアボイス！"},
        {"name": "天野香乃愛", "group_name": "≒JOY", "type": "元気", "charm": "バラエティ", "message": "笑顔がはじける癖強ハッピー担当！"},
        {"name": "市原愛弓", "group_name": "≒JOY", "type": "クール", "charm": "ダンス", "message": "クールオーラの不思議ガール！"},
        {"name": "江角怜音", "group_name": "≒JOY", "type": "クール", "charm": "バラエティ", "message": "キレのあるパフォが武器エース！"},
        {"name": "大信田美月", "group_name": "≒JOY", "type": "元気", "charm": "ダンス", "message": "運動神経抜群ムードメーカー！"},
        {"name": "小澤愛実", "group_name": "≒JOY", "type": "かわいい", "charm": "歌", "message": "愛嬌たっぷりの愛されリーダー！"},
        {"name": "大西葵", "group_name": "≒JOY", "type": "かわいい", "charm": "歌", "message": "クマさん印の最強の歌声！"},
        {"name": "高橋舞", "group_name": "≒JOY", "type": "クール", "charm": "ダンス", "message": "しなやかなパフォーマンスが魅力！"},
        {"name": "村山結香", "group_name": "≒JOY", "type": "元気", "charm": "歌", "message": "場の空気を明るくする存在！"},
        {"name": "山田杏佳", "group_name": "≒JOY", "type": "かわいい", "charm": "ダンス", "message": "優しい雰囲気のふんわりガール！"},
        {"name": "藤沢莉子", "group_name": "≒JOY", "type": "クール", "charm": "ダンス", "message": "スタイリッシュな存在感！"},
        {"name": "山野愛月", "group_name": "≒JOY", "type": "元気", "charm": "バラエティ", "message": "場を明るくする太陽みたいな二アジョイの妹！"}
